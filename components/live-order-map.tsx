...
export function LiveOrderMap({ orderId, height = 320, dark = false }: LiveOrderMapProps) {
  ...
  return (
    <View style={[styles.frame, dark && styles.frameDark, { height }]}>
      <MapView ref={mapRef} provider={PROVIDER_GOOGLE} style={StyleSheet.absoluteFill} initialRegion={{ ...center, latitudeDelta: 0.045, longitudeDelta: 0.045 }} showsCompass={false} toolbarEnabled={false}>
